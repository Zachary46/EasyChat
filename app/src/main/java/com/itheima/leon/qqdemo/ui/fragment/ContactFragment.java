...
public class ContactFragment extends BaseFragment implements ContactView {
    ...
    private void initRecyclerView() {
        ...
        mContactListAdapter = new ContactListAdapter(getContext(),mContactListItems);
    ...
    @Override
    public void onGetContactListSuccess(List<ContactListItem> list) {
        mContactListItems.clear();
        mContactListItems.addAll(list);
