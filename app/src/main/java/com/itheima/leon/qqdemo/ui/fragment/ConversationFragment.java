...
public class ConversationFragment extends BaseFragment implements ConversationView{
    ...
    protected void init() {
        ...
        mConversationAdapter =  new ConversationAdapter(getContext(), mEMConversations);
    ...
    @Override
    public void onAllConversationsLoaded(List<EMConversation> list) {
        mEMConversations.clear();
        mEMConversations.addAll(list);
        mConversationAdapter.setData(list);
        mConversationAdapter.notifyDataSetChanged();
